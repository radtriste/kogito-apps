...
// Deploy pipeline
KogitoJobTemplate.createPipelineJob(this, getJobParams('kogito-apps-deploy', 'Kogito Apps Deploy', 'Jenkinsfile.deploy')).with {
    parameters {
...
// Promote pipeline
KogitoJobTemplate.createPipelineJob(this, getJobParams('kogito-apps-promote', 'Kogito Apps Promote', 'Jenkinsfile.promote')).with {
    parameters {
        stringParam('DISPLAY_NAME', '', 'Setup a specific build display name')
...
// Sonarcloud
def sonarcloudJobParams = getJobParams('kogito-apps-sonarcloud', 'Kogito Apps Daily Sonar', 'Jenkinsfile.sonarcloud')
